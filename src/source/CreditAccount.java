...
public class CreditAccount extends Account
{
	...
	{
		return super.toString() + String.format("Credit amount: %9.2f | Min credit to pay: %8.2f | Interest rate: %8.4f", this.creditOwing, this.minCreditPayment, this.getInterestRate() - 1);
	}
}
